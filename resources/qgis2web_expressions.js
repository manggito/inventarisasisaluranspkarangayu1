...
function exp_label_BANGUNANSPKARANGAYU1_10_eval_expression(context) {
    // NAME + ' ' + URUTAN + ' ' + PEMBAGIAN

    var feature = context.feature;
    
    if (feature.properties) {
        return ((((feature.get('NAME')  + ' ') + feature.get('URUTAN') ) + ' ') + feature.get('PEMBAGIAN') );
    } else {
        return ((((feature.get('NAME')  + ' ') + feature.get('URUTAN') ) + ' ') + feature.get('PEMBAGIAN') );
    }
}